...
public class LineChartActivity2 extends DemoBase implements SeekBar.OnSeekBarChangeListener,
    ...
    protected void initViews() {
        setupToolbar(mToolbar, R.string.ci_1_name, R.string.ci_1_desc, R.menu.line, true);
    }
